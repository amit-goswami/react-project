            ...
            <div className="support-child2">
                   {
                    SupportData.map(data=>{
                        return(
                            ...
                            <div className="support-learn-with-us-parent1"><Link to="" className="support-learn-with-us-child1">Learn with Us <img src={rightarrow}/></Link></div>
                        </div>
                        ...
                        <div className="support-faq">FAQs</div>
                            <p className="support-lorem">{data.lorem}</p>
                           <div className="support-explore-faq-us-parent2" onClick={handleClick}> <Link to=""  className="support-explore-faq-us-child2">Explore FAQs <img src={rightarrow}/></Link></div>
                        </div>
                        ...
                        <div className="support-support">Support</div>
                            <p className="support-lorem">{data.lorem}</p>
                            <div className="support-support-us-parent3"> <Link  className="support-support-us-child3">Mail Us <img style={{color:'white'}}src={rightarrow}/></Link></div>
                        </div>
                        </>
                        )
                    })
