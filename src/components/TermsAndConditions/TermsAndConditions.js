...
function TermsAndConditions() {
  ...
  function TickIcon() {
    return (
      ...
      >
        <path
          fill="#2747DD"
          d="M20.537 10.094c-.02 5.543-4.625 10.023-10.286 10.007C4.589 20.084.016 15.578.036 10.036.056 4.493 4.662.013 10.323.029c5.661.017 10.234 4.523 10.214 10.065zM9.082 15.375l7.632-7.424a.638.638 0 00.003-.915l-.932-.919a.671.671 0 00-.935-.002l-6.224 6.054L5.74 9.326a.671.671 0 00-.935-.003l-.938.913a.638.638 0 00-.004.916l4.284 4.22a.671.671 0 00.935.003z"
        ></path>
      </svg>
    );
  }
  ...
  return (
    <>
      ...
      <div className="terms-and-conditions-footer-container">
        <Footer />
      </div>
    </>
  );
